...
def _logistic_regression(x_train, y_train, x_test=None, y_test=None):
...
def logistic_regression_split(x, y):
...
def _cross_evaluate():
    ...
    cross_evaluate(_logistic_regression, combined_features, labels, split=4)
...
def _split_evaluate():
    ...
    clf = logistic_regression_split(combined_features, labels)
...
def _run_for_test(output_path):
    ...
    clf = _logistic_regression(train_features, train_labels)
...
if __name__ == '__main__':
    # logistic_regression('../output/knn/knn.txt')
    # _cross_evaluate()
    _split_evaluate()
