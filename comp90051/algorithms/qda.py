...
def _qda(x_train, y_train, x_test=None, y_test=None):
    clf = QDA()
...
def _cross_evaluate():
    ...
    cross_evaluate(_qda, combined_features, labels, split=4)
...
def _split_evaluate():
    ...
    clf = qda_split(combined_features, labels)
...
def _run_for_test(output_path):
    ...
    clf = _qda(train_features, train_labels)
